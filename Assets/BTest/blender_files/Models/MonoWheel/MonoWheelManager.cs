...
public class MonoWheelManager : MonoBehaviour
{
    ...
    private void Drive()
    {
        playerManager.Animator.SetBool("Drive", true);
    ...
    private void ExitVehicle()
    {
        ...
        playerManager.Animator.SetBool("Drive", false);
        PlayerCamera.Instance.playerCamera.enabled = true;
        vehicleCamera.enabled = false;
        playerManager.transform.position = exitPosition.position;
        playerManager.transform.rotation = exitPosition.rotation;
    }
    ...
    {
        isDriving = true;
        PlayerCamera.Instance.playerCamera.enabled = false;
    ...
    {
        playerManager.transform.position = seatPosition.position;
        playerManager.transform.rotation = seatPosition.rotation;
    }
